                ...
                <div id="auth-user" class="auth-user" hidden>
                    <div class="user-menu" id="user-menu">
                        ...
                        <div class="user-menu-panel" id="user-menu-panel" hidden role="menu">
                            ...
                            <a href="{{ route('web.blocked') }}" class="user-menu-item {{ $path === 'blocked' ? 'active' : '' }}" data-role="any" role="menuitem" data-i18n="web.nav.blocked">{{ wt('web.nav.blocked', 'Bloklanmışlar') }}</a>
